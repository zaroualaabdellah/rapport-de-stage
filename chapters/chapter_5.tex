...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{images/page_historique.png} % Remplacer par le bon chemin
...
\subsubsection*{Étape 1 : Sélection du fichier CV}
...
\captionof{figure}{Interface de sélection du fichier CV}
\end{center}
...
\captionof{figure}{Indicateur de chargement pendant l’analyse du CV}
\end{center}
...
\captionof{figure}{Aperçu des données extraites du CV}
\end{center}
...
\captionof{figure}{Analyse du profil de l'utilisateur}
\end{center}
...
\captionof{figure}{Création des recommandations personnalisées}
\end{center}
...
\captionof{figure}{Affichage final des recommandations de cours}
\end{center}